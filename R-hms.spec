...
Version  : 1.0.0
Release  : 53
URL      : https://cran.r-project.org/src/contrib/hms_1.0.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/hms_1.0.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1610579007
