...
Version  : 0.5.2
Release  : 46
URL      : https://cran.r-project.org/src/contrib/hms_0.5.2.tar.gz
Source0  : https://cran.r-project.org/src/contrib/hms_0.5.2.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572445045
