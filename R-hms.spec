...
Version  : 1.1.0
Release  : 58
URL      : https://cran.r-project.org/src/contrib/hms_1.1.0.tar.gz
Source0  : https://cran.r-project.org/src/contrib/hms_1.1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1621287200
