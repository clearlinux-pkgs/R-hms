...
Version  : 1.1.3
Release  : 75
URL      : https://cran.r-project.org/src/contrib/hms_1.1.3.tar.gz
Source0  : https://cran.r-project.org/src/contrib/hms_1.1.3.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1679504401
